...
(function () {
    ...
    1: [function (require, module, exports) {
        ...
        var HTTPProvider = require("./lib/provider/HTTPProvider");

        var IOST = require("./iost/iost");

        var KeyPair = require("./lib/crypto/key_pair");

        var Signature = require("./lib/crypto/signature");

        var _require = require("./lib/structs"),
            Tx = _require.Tx;

        var Algorithm = require("./lib/crypto/algorithm");

        var Account = require("./iost/account");

        var TxHandler = require("./iost/tx_handler");
        ...
        "./iost/iost": 4,
        "./iost/tx_handler": 5,
        "./lib/crypto/algorithm": 7,
        "./lib/crypto/key_pair": 10,
        "./lib/crypto/signature": 11,
        "./lib/provider/HTTPProvider": 13,
        "./lib/rpc": 14,
        "./lib/structs": 15,
        "bs58": 45
    }],
    2: [function (require, module, exports) {
        var Account = /*#__PURE__*/function () {
            ...
            _createClass(Account, [{
                ...
                key: "getKeyPair",
                value: function getKeyPair(permission) {
                    return this._key_pair[permission];
                }
            }, {
                key: "sign",
                value: function sign(t, permission) {
                    t.addSign(this._key_pair[permission]);
                }
            }, {
                key: "signTx",
                value: function signTx(t) {
    ...
    3: [function (require, module, exports) {
        var Callback = /*#__PURE__*/function () {
            ...
            _createClass(Callback, [{
                ...
                key: "pushMsg",
                value: function pushMsg(msg, args) {
                    var f = this.map[msg];
    ...
    4: [function (require, module, exports) {
        ...
        var _require2 = require('../lib/structs'),
            Tx = _require2.Tx;

        var TxHandler = require('./tx_handler');
        ...
        var IOST = /*#__PURE__*/function () {
            function IOST(config) {
                _classCallCheck(this, IOST);
            ...
            _createClass(IOST, [{
                key: "callABI",
                value: function callABI(contract, abi, args) {
                    var t = new Tx(this.config.gasRatio, this.config.gasLimit);
                ...
                key: "transfer",
                value: function transfer(token, from, to, amount) {
                ...
                key: "newAccount",
                value: function newAccount(name, creator, ownerkey, activekey, initialRAM, initialGasPledge) {
                ...
                key: "_checkPublicKey",
                value: function _checkPublicKey(key) {
                    var b = Base58.decode(key);
                    return b.length === 32;
                }
                /**
                 * 直接发送交易
                ...
                key: "setRPC",
                value: async function setRPC(rpc) {
                    this.currentRPC = rpc;
                    var requestStartTime = new Date().getTime() * 1e6;
                    var nodeInfo = await this.currentRPC.net.getNodeInfo();
    ...
    5: [function (require, module, exports) {
        var _require3 = require('../lib/structs'),
            Tx = _require3.Tx;

        var TxHandler = /*#__PURE__*/function () {
            function TxHandler(tx, rpc) {
                _classCallCheck(this, TxHandler);
            ...
            _createClass(TxHandler, [{
                key: "onPending",
                value: function onPending(c) {
                    var self = this;
                    ...
                    this.Pending = function (res) {
                        ...
                        try {
                            ...
                            if (_typeof(p) === "object" && typeof p.catch === 'function') {
                                p.catch(function (e) {
                                    return console.error("on pending failed. ", e);
                                });
                            }
                        } catch (e) {
                ...
                value: function onSuccess(c) {
                    ...
                    this.Success = function (res) {
                        ...
                        try {
                            ...
                            if (_typeof(p) === "object" && typeof p.catch === 'function') {
                                p.catch(function (e) {
                                    return console.error("on success failed. ", e);
                                });
                            }
                        } catch (e) {
                ...
                value: function onFailed(c) {
                    ...
                    this.Failed = function (res) {
                        ...
                        try {
                            ...
                            if (_typeof(p) === "object" && typeof p.catch === 'function') {
                                p.catch(function (e) {
                                    return console.log("on failed failed. ", e);
                                });
                            }
                        } catch (e) {
                ...
                key: "listen",
                value: function listen(interval, times) {
                    if (!interval || !times) {
                        interval = 1000;
                        times = 90;
                    }
                ...
                key: "SimpleTx",
                value: function SimpleTx(contract, abi, args, config) {
                    var t = new Tx(config.gasRatio, config.gasLimit, config.delay);
                    t.addAction(contract, abi, JSON.stringify(args));
                    return t;
                }
            }]);
    ...
    6: [function (require, module, exports) {
        ...
        var Blockchain = /*#__PURE__*/function () {
            ...
            _createClass(Blockchain, [{
                ...
                key: "getBlockByHash",
                value: function getBlockByHash(hash, complete) {
                ...
                key: "getBlockByNum",
                value: function getBlockByNum(num, complete) {
                ...
                value: function getToken721Balance(address, tokenSymbol) {
                    var useLongestChain = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
                ...
                value: function getToken721Metadata(tokenSymbol, tokenID) {
                    var useLongestChain = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
                ...
                value: function getToken721Owner(tokenSymbol, tokenID) {
                    var useLongestChain = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
                ...
                value: function getContractStorage(contractID, key) {
                ...
                value: function getContractStorageFields(contractID, key) {
                ...
                key: "getAccountInfo",
                value: function getAccountInfo(id, reversible) {
                ...
                key: "getGasUsage",
                value: function getGasUsage(actionName) {
                    switch (actionName) {
                        case "transfer":
                            return 7800;
                ...
                value: function getExchangeContractInfo() {
                    return {
        ...
        (function (Buffer) {
            ...
            var Codec = /*#__PURE__*/function () {
                ...
                _createClass(Codec, [{
                    ...
                    key: "pushInt64",
                    value: function pushInt64(n) {
                        var l = Long.fromString(n + "");
            ...
            var KeyPair = /*#__PURE__*/function () {
                function KeyPair(priKeyBytes) {
                    ...
                    if (this.t === Algorithm.Ed25519) {
                        var kp = nacl.sign.keyPair.fromSeed(priKeyBytes.slice(0, 32));
                        ...
                        var secpKey = secp.keyFromPrivate(priKeyBytes);
                ...
                _createClass(KeyPair, [{
                    ...
                    key: "B58PubKey",
                    value: function B58PubKey() {
                        return base58.encode(this.pubkey);
                    }
                }], [{
                    key: "newKeyPair",
                    value: function newKeyPair() {
    ...
    11: [function (require, module, exports) {
        (function (Buffer) {
            ...
            var Signature = /*#__PURE__*/function () {
                function Signature(info, keyPair) {
    ...
    15: [function (require, module, exports) {
        var Codec = require('./crypto/codec');

        var Signature = require('./crypto/signature');

        var sha3 = require('sha3');

        var KeyPair = require('./crypto/key_pair');

        var Tx = /*#__PURE__*/function () {
            function Tx(gasRatio, gasLimit) {
            ...
            _createClass(Tx, [{
                ...
                key: "addSigner",
                value: function addSigner(name, permission) {
                    this.signers.push(name + "@" + permission);
                }
            }, {
                key: "addApprove",
                value: function addApprove(token, amount) {
                ...
                key: "getApproveList",
                value: function getApproveList() {
                    var approveList = {};
                    this.amount_limit.forEach(function (element) {
                ...
                key: "addAction",
                value: function addAction(contract, abi, args) {
                    this.actions.push({
                        contract: contract,
                        actionName: abi,
                        data: args
                ...
                key: "setTime",
                value: function setTime(expirationInSecound, delay, serverTimeDiff) {
                    var date = new Date();
                ...
                key: "setGas",
                value: function setGas(gasRatio, gasLimit) {
                ...
                key: "addSign",
                value: function addSign(kp) {
                    var sig = new Signature(this._base_hash(), kp);
                    this.signatures.push(sig);
                }
            }, {
                key: "_publish_hash",
                value: function _publish_hash() {
                    var hash = sha3.SHA3(256);
                ...
                key: "addPublishSign",
                value: function addPublishSign(publisher, kp) {
                    ...
                    var sig = new Signature(info, kp);
                    this.publisher_sigs.push(sig);
                }
            }, {
                key: "_bytes",
                value: function _bytes(n) {
                    var c = new Codec();
                    ...
                    for (var _i2 = 0; _i2 < this.actions.length; _i2++) {
                        var c2 = new Codec();
                        c2.pushString(this.actions[_i2].contract);
                        c2.pushString(this.actions[_i2].actionName);
                        c2.pushString(this.actions[_i2].data);
                        c.pushBytes(c2._buf);
                    }

                    c.pushInt(this.amount_limit.length);

                    for (var _i3 = 0; _i3 < this.amount_limit.length; _i3++) {
                        var _c = new Codec();

                        _c.pushString(this.amount_limit[_i3].token);

                        _c.pushString(this.amount_limit[_i3].value + "");
                    ...
                    if (n > 0) {
                        ...
                        for (var _i4 = 0; _i4 < this.signatures.length; _i4++) {
                            c.pushBytes(this.signatures[_i4]._bytes());
                        }
                    }
    ...
    16: [function (require, module, exports) {
        ...
        var Transaction = /*#__PURE__*/function () {
            ...
            _createClass(Transaction, [{
                ...
                key: "getTxByHash",
                value: function getTxByHash(hash) {
                ...
                value: function getTxReceiptByHash(hash) {
                ...
                value: function getTxReceiptByTxHash(txHash) {
    ...
    18: [function (require, module, exports) {
        ...
        "./../helpers/buildURL": 32,
        "./../helpers/cookies": 34,
        "./../helpers/isURLSameOrigin": 36,
        "./../helpers/parseHeaders": 38,
        "./../utils": 40
    }],
    ...
    26: [function (require, module, exports) {
        ...
        "../cancel/isCancel": 22,
        "../defaults": 30,
        "./../helpers/combineURLs": 33,
        "./../helpers/isAbsoluteURL": 35,
        "./../utils": 40,
        "./transformData": 29
    }],
    ...
    30: [function (require, module, exports) {
        ...
        "./adapters/http": 18,
        "./adapters/xhr": 18,
        "./helpers/normalizeHeaderName": 37,
        "./utils": 40,
        "_process": 98
    }],
    ...
    53: [function (require, module, exports) {
        ...
        function EC(options) {
            if (!_instanceof(this, EC)) return new EC(options); // Shortcut `elliptic.ec(curve-name)`
            ...
            if (_instanceof(options, elliptic.curves.PresetCurve)) options = {
                curve: options
            };
    ...
    60: [function (require, module, exports) {
        ...
        "bn.js": 43,
        "minimalistic-assert": 77,
        "minimalistic-crypto-utils": 78
    }],
    61: [function (require, module, exports) {
        module.exports = {
            "_args": [["elliptic@6.4.1", "/Users/chenda/Documents/work/wallet-js/iost.js"]],
    ...
    85: [function (require, module, exports) {
        ...
        var _roundConstants = _interopRequireDefault(require("./round-constants"));
      ...
      /* x, n */ {
            ...
            */
            ...
            function checkArrayTypes() {
                for (var i = 0; i < arguments.length; i++) {
                    if (!_instanceof(arguments[i], Uint8Array)) throw new TypeError('unexpected type, use Uint8Array');
                }
            }
    ...
    96: [function (require, module, exports) {
        ...
        function isArrayBuffer(obj) {
            return _instanceof(obj, ArrayBuffer) || obj != null && obj.constructor != null && obj.constructor.name === 'ArrayBuffer' && typeof obj.byteLength === 'number';
        }
